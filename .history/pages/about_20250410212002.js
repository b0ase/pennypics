  ...
  return (
    <div style={{ 
      ...
      <main style={{ 
        ...
        <div style={{ 
          ...
          <p style={{
            ...
            PennyPics.store is a web application that uses advanced AI technology from Stability AI 
            to generate stunning, creative images based on your text descriptions. Whether you're 
            looking for inspiration, creating concept art, or just having fun with AI, PennyPics.store 
          ...
          <p style={{
            ...
            PennyPics.store is built with Next.js, a React framework for production-grade applications.
          ...
          <p style={{
            ...
            PennyPics.store leverages Solana blockchain technology to provide a seamless payment experience.
      ...
      <footer style={{
        ...
        <p style={{ margin: '0 0 0.5rem' }}>© {new Date().getFullYear()} PennyPics.store. All rights reserved.</p>
