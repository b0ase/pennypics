...
export default function Home() {
  ...
  const handlePaymentAndGenerate = async () => {
    ...
    try {
      ...
      // Process the payment - skip detailed balance checks to avoid showing errors to users
      ...
      try {
        ...
        // Show success message with minimal information 
        setSuccess(`Payment processed successfully`);
        ...
        // Instead of showing detailed RPC errors, show a generic message
