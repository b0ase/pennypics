  ...
  const handlePaymentAndGenerate = async () => {
    ...
    const paymentTimeout = setTimeout(() => {
      ...
      if (isProcessingPayment) {
        ...
        setSuccess("Image generation started");
        generateImage();
      }
    ...
    try {
      ...
      try {
        ...
        if (paymentError.message && (
          ...
          // For development, proceed to generate image even if payment failed
          if (process.env.NODE_ENV === 'development') {
            console.log("Development mode: proceeding despite payment error");
            setSuccess("Proceeding with image generation");
            await generateImage();
            return;
          }
