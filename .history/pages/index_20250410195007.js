      ...
      try {
        ...
        const newImages = data.images.map(imageBase64 => {
          ...
          if (!imageBase64 || typeof imageBase64 !== 'string') {
            console.error("Invalid image data:", imageBase64);
            return null;
          }
          return `data:image/png;base64,${imageBase64.replace(/^data:image\/png;base64,/, '')}`;
        ...
        console.log("GENERATE_IMAGE: Created image URLs. Count:", newImages.length);
