            ...
            {selectedImage && (
              <div style={{ 
                ...
                <div style={{
                  ...
                  {(selectedImage.thumbnail || (selectedImage.images && selectedImage.images.length > 0)) && (
                    <div 
                      style={{
                        backgroundColor: 'var(--bg-tertiary)',
                        borderRadius: '8px',
                    ...
                    >
                      <img 
                        src={selectedImage.thumbnail || selectedImage.images[0]} 
                      ...
                      <div style={{ 
                        ...
                        <a 
                          href={selectedImage.thumbnail || selectedImage.images[0]}
