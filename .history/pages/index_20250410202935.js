...
export default function Home() {
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      ...
      try {
        // Use a guaranteed static image instead of API
        console.log("GENERATE_IMAGE: Using static image instead of API");
        
        // Create a simple static image
        const staticImage = 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=1064&auto=format&fit=crop';
        
        // Set the image
        const newImages = [staticImage];
