...
export async function checkBalance(wallet, connection) {
  ...
  try {
    ...
    // If all endpoints failed, we cannot determine balance
    console.error("All RPC endpoints failed when checking balance");
    throw new Error('Could not connect to any Solana network to check balance');
  } catch (error) {
